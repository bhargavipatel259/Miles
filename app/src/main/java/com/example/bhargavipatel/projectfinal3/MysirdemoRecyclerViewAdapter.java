...
import com.example.bhargavipatel.projectfinal3.sirdemoFragment.OnListFragmentInteractionListener;
 ...
 */
public class MysirdemoRecyclerViewAdapter extends RecyclerView.Adapter<MysirdemoRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MysirdemoRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_sirdemo, parent, false);
